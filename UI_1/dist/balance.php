                ...
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <!-- <li class="nav-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow">
                      ...
                      <a href="./balance.html" class="dropdown-item active">View Balance</a>
                    </div>
                  </li> -->
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="page-header">
                <h1 class="page-title">
                    <a href="./index.php" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>Home</a> | View Balance
                  </h1>
            </div>
                                    ...
                                    <form action="">
                                            ...
                                            <fieldset class="form-fieldset">
                                                    <div class="form-group">
                                                      <label class="form-label">Balance for Society Name: <?php echo $society_name ?> Is R<?php echo $last_balance ?><span class="form-required">*</span></label>
                                                    </div>
