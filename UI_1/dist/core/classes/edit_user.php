...
$id =$_REQUEST['id'];
$view_users = $users->get_user_information($id);
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <?php foreach ($view_society as $row) { ?>
                      <div class="form-group">
                          <label class="form-label">Society name</label>
                          <input type="text" name="society_name" class="form-control" value="<?php echo $row['society_name']?>" >
                      </div>
                      ...
                      <div class="form-group">
                            ...
                            <input disabled="disabled" type="text" name="init_captital" class="form-control" value="<?php echo $row['init_capital']?>" >
                        </div>
