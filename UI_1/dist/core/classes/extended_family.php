...
class Extended_family{
	...
	public function add_extended_family($main_member_id, $first_name, $last_name, $gender, $id_number, $contact_number, $relation)
	{
		$date_inception = time(); 
		...
		header('Location:extended_family.php?main_member_id='.$main_member_id);

	}
	
	public function update_extended_family($first_name, $last_name, $gender, $contact_number, $relation, $family_id, $main_member_id)
	{
		...
		header('Location: view_extended_family.php?main_member_id='.$main_member_id);
	}

	public function extended_family_id_exists($id_number) 
	{
	...
	public function allExtendedFamilyInformation() 
	{
		$type = "Extended family";
		$deceased = "No";
	...
	public function extended_family_data($family_id) 
	{
	...
	public function all_extended_family_data($main_member_id) 
	{
		$type = "Extended family";
		$deceased = "No";
	...
	public function deleteExtendedFamilyMember($family_id) 
	{
