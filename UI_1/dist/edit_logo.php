...
{
    $users->edit_logo($user_id, $file_name);
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="page-header">
              <h1 class="page-title">
                <a href="./index.php" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>Home</a> | Update Logo
              </h1>
            </div>

            <div class="col-lg-12">
              <div class="card">
                <div class="card-body text-centery">
