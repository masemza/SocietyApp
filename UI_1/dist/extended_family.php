...
$extended_family_data = $extended_family->all_extended_family_data($main_member_id);
          ...
          $errors[] = 'Only letters and white space allowed for First name';
            ...
            if(!preg_match("/^[a-zA-Z ]*$/",$_POST['last_name']))
            {
              $errors[] = 'Only letters and white space allowed for Last name';
                    ...
                    if($extended_family->extended_family_id_exists($_POST['id_number']) === true) 
                    {
                        ...
                        {			
                          ...
                          $extended_family->add_extended_family($main_member_id, $first_name, $last_name, $gender, $id_number, $contact_number, $relation);
            ...
            <div class="nav-item d-md-flex">
              ...
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item">
                    <a href="javascript:void(0)" class="nav-link active" data-toggle="dropdown"><i class="fe fe-users"></i>Manage Extended Family</a>
                    <div class="dropdown-menu dropdown-menu-arrow">
                      ...
                      <a href="./extended_family.php?main_member_id=<?php echo $main_member_id ?>" class="dropdown-item active"><i class="fe fe-user-plus"></i>Add Extended Family</a>
                    </div>
                  </li>
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="page-header">
              <h1 class="page-title">
                <a href="view_extended_family.php?main_member_id=<?php echo $main_member_id?>"> <i class="fe fe-arrow-left"></i>View Extended Family Details</a> | Add Spouse
              </h1>
            </div>
                ...
                <div class="card p-1 align-items-center">
                  <div class="d-flex align-items-center">
                    <div class="col-lg order-lg-first">
                      <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                        <li class="nav-item">
                          <a href="spouse.php?main_member_id=<?php echo $main_member_id ?>" class="nav-link"><i class="fe fe-user-plus"></i>Add Spouse</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="card p-1 align-items-center">
                  <div class="d-flex">
                    <div class="col-lg order-lg-first">
                      <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                        <li class="nav-item">
                          <a href="javascript:void(0)" class="nav-link active"><i class="fe fe-user-plus"></i>Add Extended Family</a>
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <?php 
            if(!empty($extended_family_data))
            {?>
              <?php foreach($extended_family_data as $extended_family_row)
              {?>
                <div class="col-lg-12">
                  <div class="card">
                    <div class="card-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="first_name" class="form-control" disabled="true" placeholder="Enter First Name" value="<?php echo $extended_family_row['first_name'] ?>" >
                              </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="last_name" class="form-control" disabled="true" placeholder="Enter Last Name" value="<?php echo $extended_family_row['last_name'] ?>" >
                              </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-6">
                              <div class="form-group">
                                ...
                                <select name="gender" class="form-control custom-select" disabled="true">
                                        <option value="" disabled selected><?php echo $extended_family_row['gender'] ?></option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="number" name="contact_num" class="form-control" disabled="true" placeholder="Enter Contact Number" value="<?php echo $extended_family_row['contact_number'] ?>" >
                              </div>
                            </div> 
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="number" name="id_number" class="form-control" disabled="true" placeholder="Enter ID Number" value="<?php echo $extended_family_row['id_number'] ?>" >
                              </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-6">
                              <div class="form-group">
                                ...
                                <select name="relation" class="form-control custom-select" disabled="true">
                                        <option value="" disabled selected><?php echo $extended_family_row['relation'] ?></option>
                                </select>
                              </div>
                            </div>    
              ...
              <div class="col-lg-12">
                <div class="card">
                  ...
                  {?>
                    <a href="./manage_members.php" class="btn btn-primary" role="button">Save and continue</a>
                  <?php
                  }
                  else if($type == 'user')
                  {?>
                    <a href="./index.php" class="btn btn-primary" role="button">Save and continue</a>
                  <?php
                  }?>
                </div>
              </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6">
                          <div class="form-group">
                            <label class="form-label">Relation</label>
                            <select name="relation" class="form-control custom-select" required="required" >
                                    <option value="<?php if(isset($_POST['relation'])) echo htmlentities($_POST['relation']); ?>" disabled selected>Select Relation</option>
                      ...
                      <div class="card-footer text-right">
                        ...
                        <?php if($type == 'admin' || $type == 'manager')
                        {?>
                          <a href="./manage_members.php" class="btn btn-primary" role="button">Skip</a>
                        <?php
                        }
                        else if($type == 'user')
                        {?>
                          <a href="./index.php" class="btn btn-primary" role="button">Skip</a>
                        <?php
                        }?>
                      </div>
