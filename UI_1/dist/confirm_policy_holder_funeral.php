...
$view_member_data = $main_member->get_member_data_using_family_id($family_id);
foreach($view_member_data as $view_member_row){}
...
if(isset($_POST['edit']))
{
  header('Location: edit_policy_holder_funeral.php?policy_holder_funeral_id='.$policy_holder_funeral_id);
}

if(isset($_POST['confirm']))
{
   header('location: policy_holder_funeral_receipt.php?policy_holder_funeral_id='.$policy_holder_funeral_id);

  // Print '<script>alert("Funeral Arrangement Successfully Made");;
          ...
          <div class="container">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row my-6">
                  <div class="col-6">
                    <p class="h3">Name of Deceased: <u><?php echo $view_member_row['first_name'] ?> <?php echo $view_member_row['last_name'] ?></u> </p>
                  </div>
                ...
                <h4> <p class="text-right"> FUNERAL NO: <?php echo $row['policy_holder_funeral_id'] ?></p> </h4>

                <div class="table-responsive push">
                  <table class="table table-bordered table-hover">
                    <tr>
                      <th class="text-left" >Informant First Name</th>
                      <td class="text-center"><?php echo $row['informant_first_name']; ?></td>
                    </tr>

                    <tr>
                      <th class="text-left" >Informant Last Name</th>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <?php echo $row['informant_province']; ?> <br>
                      </td>
                    </tr>
                ...
                <div class="row my-12">
                  <div class="col-12 text-right">
                    <form action="" method="post">
                     <button type="submit" name="edit" class="btn btn-primary">Edit Funeral Arrangement</button>
