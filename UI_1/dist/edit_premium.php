...
$member_statement = $main_member->member_statement_data($member_payment_id);
foreach($member_statement as $member_statement_row)
{
...
if (isset($_POST['pay_premium'])) 
{
    ...
    if(!preg_match("/^[a-zA-Z ]*$/",$name))      
    {
        ...
        $new_balance = $last_balance - $member_statement_row['credit'];

			  $balance = $new_balance + $amount;

			  $main_member->update_premium($name, $amount, $date_of_premium, $balance, $member_payment_id);
                ...
                <div class="card-body">
                  ...
                  <form action="" method="POST">
                    ...
                    <fieldset class="form-fieldset">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="number" name="amount" required="required" class="form-control" placeholder="Enter amount" value="<?php echo $member_statement_row['credit'] ?>" />
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="date_of_premium" class="form-control" required="required" value="<?php echo $member_statement_row['paid_for'] ?>" />
                        </div>
                      </div>
                    ...
                    <div class="btn-list text-center">
                      ...
                      <a href="./delete_premium.php?member_payment_id=<?php echo $member_payment_id ?>" class="btn btn-primary" role="button">Cancel Premium</a>
                    </div>
