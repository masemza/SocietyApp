            ...
            <div class="row align-items-center">
              <div class="col-lg order-lg-first">
                ...
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item">
                    <a href="javascript:void(0)" class="nav-link active"><i class="fe fe-file-text"></i>Withdrawal Report</a>
                  </li>
        ...
        <div class="my-3 my-md-5 ">
          <div class="container ">
            <div class="page-header">
              <h1 class="page-title">
                <a href="view_member_report.php" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>View Report</a> | View Withdrawal Report 
              </h1>
            </div>

            <?php if($view_withdrawals)
            {?>
              <div class="col-sm-6 col-lg-">
                <div class="card p-3">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h4 class="m-0"><a href="javascript:void(0)"><small>Total Withdrawals</small></a></h4>
                      ...
                      <div class="table-responsive push">
                        <table class="table table-bordered table-hover">
                          <tr>
                            ...
                            <?php foreach ($view_withdrawals as $view_withdrawals_row) 
                            {?>
                              <tr>
                                ...
                                <td>
                                  <p class="font-w600 mb-1 text-center">
                                    <?php $date=date_create($view_withdrawals_row['date_transaction']);
                                    echo date_format($date,"d-m-Y");?> 
                                  </p>
                                </td>

                                <td class="text-center">
                                  <a href="receipt.php?payment_id=<?php echo $view_withdrawals_row['payment_id'] ?>"> 
                                    <?php echo $view_withdrawals_row['payment_id'] ?>
                                  </a>
                                </td>
                                
                                <td class="text-center">
                                  <?php echo $view_withdrawals_row['name']; ?>
                                </td>

                                <td class="text-center">
                                  <?php echo $view_withdrawals_row['deceased_name']; ?>
                                </td>
                                
                                <td class="text-center"><?php echo number_format($view_withdrawals_row['debit'],2) ?></td>
                            ...
                            <td class="font-weight-bold text-center">R<?php echo number_format($total_withdrawals, 2) ?> </td>         
