...
$view_extended_family = $extended_family->allExtendedFamilyInformation();
                ...
                <form class="input-icon my-3 my-lg-0" action="" method="post" >
                  ...
                  <div class="form-group">
                    <div class="row gutters-xs">
                      <div class="col">
                        <input type="text" name="search" id="myInput" onkeyup="myFunction()" class="form-control" placeholder="Enter Expended Family Name" required="required">
                      </div>
                      <span class="col-auto">
                ...
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item">
                      ...
                      <div class="dropdown-menu dropdown-menu-arrow">
                        ...
                        <a href="./view_all_extended_family.php" class="dropdown-item active"><i class="fe fe-users"></i>View Extended Family</a>
                      </div>
                    </li>
          ...
          <div class="container">
            <div class="page-header">
              <h1 class="page-title">
                ...
                {?>
                  <a href="manage_members.php" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>Home</a> | Extended Family Details
                <?php
                }?>
              </h1>
            </div>
                  ...
                  <div class="card p-1 align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="col-lg order-lg-first">
                          <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                            <li class="nav-item">
                              <a href="./view_all_children.php" class="nav-link"><i class="fe fe-users"></i>View Children</a>
                            </li>
                          </ul>
                        </div>
                  ...
                  <div class="card p-1 align-items-center">
                    <div class="d-flex">
                          ...
                          <div class="col-lg order-lg-first">
                            <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                              <li class="nav-item">
                                <a href="./view_all_extended_family.php" class="nav-link active"><i class="fe fe-users"></i> View Extended Family</a>
                              </li>
                            </ul>
                          </div>
