...
$view_extended_family = $extended_family->extended_family_data($family_id);
foreach($view_extended_family as $extended_family_row)
{
    $main_member_id = $extended_family_row['main_member_id'];
}
    ...
    if (strlen($_POST['contact_num']) !=10)
    {
	  ...
	  {		
      	...
      	$relation       = $_POST['relation'];
		    ...
		    $extended_family->update_extended_family($first_name, $last_name, $gender, $contact_number, $relation, $family_id, $main_member_id);

        if($type == 'admin' || $type == 'manager')
        {
            Print '<script>alert("Extended family member Successfully edited");;
                ...
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow">
                      ...
                      <a href="./edit_extended_family.php?main_member_id=<?php echo $main_member_id ?>" class="dropdown-item active"><i class="fe fe-edit"></i>Add Extended Family</a>
                    </div>
                  </li>
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="page-header">
              <h1 class="page-title">
                <a href="./view_extended_family.php?main_member_id=<?php echo $extended_family_row['main_member_id'] ?>" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>Extended Family Details</a> | Edit Extended Family Details
              </h1>
            </div>
                ...
                <div class="card-body">
                  ...
                  <form action="" method="post">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="first_name" class="form-control" placeholder="First Name" value="<?php echo $extended_family_row['first_name']?>" >
                      </div>

                      <div class="form-group">
                        <label class="form-label">Surname</label>
                        <input type="text" name="last_name" class="form-control" placeholder="Last Name" value="<?php echo $extended_family_row['last_name']?>">
                      </div>

                      <div class="form-group">
                          <label class="gender">Gender</label>
                          <select name = gender class="form-control" required="true">
                              <option ><?php echo $extended_family_row['gender'] ?></option>
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="contact_num" class="form-control" placeholder="Contact Number" value="<?php echo $extended_family_row['contact_number']?>">
                      </div>

                      <div class="form-group">
                          <label class="relation">Relation</label>
                          <select name = "relation" class="form-control" required="true">
                              <option ><?php echo $extended_family_row['relation'] ?></option>
                    ...
                    <div class="card-footer">
                      <button onclick ="return confirm('Are you sure you want to edit this extended family member?')" type="submit" name="submit" class="btn btn-primary btn-block" > Update extended_family</button>
                    </div>
