                ...
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow">
                      <a href="./view_spouse.php?main_member_id=<?php echo $main_member_id ?>" class="dropdown-item active"><i class="fe fe-users"></i>View Spouse</a>
          ...
          <div class="container">
            <div class="page-header">
              <h1 class="page-title">
                ...
                {?>
                  <a href="./view_main_member.php?main_member_id=<?php echo $main_member_id ?>" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>Member Details</a> | Spouse Details
                <?php
                }?>
              </h1>
            </div>
                  ...
                  <div class="card p-1 align-items-center">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="col-lg order-lg-first">
                        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                          <li class="nav-item">
                            <a href="./view_spouse.php?main_member_id=<?php echo $main_member_id ?>" class="nav-link active"><i class="fe fe-users"></i>View Spouse</a>
                          </li>
                        </ul>
                      </div>
