...
$view_total_deposit = $payment->get_all_deposits();
$num = 0;
...
if (isset($_POST['submit']))
{
  ...
  if(empty($date1) === true || empty($date2) === true )
    ...
    {
        $view_total_deposit = $payment->search_deposits($date1, $date2);
    }
}
                  ...
                  <form class="input-icon my-3 my-lg-0" action="" method="post">
                    ...
                    <div class="form-group">
                      <div class="row gutters-xs">
                        <div class="col">
                          <input type="text" name="search" id="myInput" onkeyup="myFunction()" class="form-control" required="required" placeholder="Enter Depositor Name">
                        </div>
                        <span class="col-auto">
        ...
        <div class="my-3 my-md-5 ">
          <div class="container ">
            <div class="page-header">
              <h1 class="page-title">
                <a href="index.php" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>Home</a> | View Total Deposits
              </h1>
            </div>
                ...
                <div class="d-flex align-items-center">
                  <div>
                    <form action="" method="post">
                      <h4 class="text-center">Select Deposits Statement </h4>&nbsp; 
            ...
            { 
              ...
              if(isset($_POST['submit']) && empty($view_total_deposit) )
              {?>
                <h1 class="page-title ">
                  <div class="card text-center">
                    No transaction made
            ...
            <?php if(($view_total_deposit) && (empty($errors) === true))
            {?>
                      ...
                      <div class="table-responsive push">
                        <table id="myTable" class="table table-bordered table-hover">
                          <tr>
                            ...
                            <?php foreach($view_total_deposit as $total_deposits_row) 
                            {?>
                              <tr>
                                ...
                                <td>
                                  <p class="font-w600 mb-1 text-center">
                                    <?php $date=date_create($total_deposits_row['date_transaction']);
                                    echo date_format($date,"d-m-Y");?> 
                                  </p>
                                </td>

                                <td class="text-center">
                                  <a href="receipt.php?payment_id=<?php echo $total_deposits_row['payment_id'] ?>"> 
                                    <?php echo $total_deposits_row['payment_id'] ?>
                                  </a>
                                </td>
                                
                                <td class="text-center">
                                  <?php echo $total_deposits_row['name']; ?>
                                </td>
                                
                                <td class="text-center"><?php echo number_format($total_deposits_row['credit'],2) ?></td>
                                
                                <td class="text-center"><?php echo number_format($total_deposits_row['balance'],2) ?></td>
                              </tr>
                            <?php 
                            } ?>
