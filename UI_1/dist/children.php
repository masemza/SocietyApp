...
$children_data = $children->all_children_data($main_member_id);
          ...
          $errors[] = 'Only letters and white space allowed for First name';
            ...
            if(!preg_match("/^[a-zA-Z ]*$/",$_POST['last_name']))
            {
              $errors[] = 'Only letters and white space allowed for Last name';
                    ...
                    if($children->children_id_exists($_POST['id_number']) === true) 
                    {
                        ...
                        {			
                          ...
                          $children->add_children($main_member_id, $first_name, $last_name, $gender, $id_number, $contact_number);
                ...
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow">
                      ...
                      <a href="./children.php?main_member_id=<?php echo $main_member_id ?>" class="dropdown-item active"><i class="fe fe-user-plus"></i>Add A Child</a>
                    </div>
                  </li>
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="page-header">
              <h1 class="page-title">
                <a href="view_children.php?main_member_id=<?php echo $main_member_id?>"> <i class="fe fe-arrow-left"></i>View Children's Details</a> | Add A Child
              </h1>
            </div>
                ...
                <div class="card p-1 align-items-center">
                  <div class="d-flex align-items-center">
                    <div class="col-lg order-lg-first">
                      <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                        <li class="nav-item">
                          <a href="javascript:void(0)" class="nav-link active"><i class="fe fe-user-plus"></i>Add Children</a>
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            {?>
              <?php foreach($children_data as $children_row)
              {?>
                <div class="col-lg-12">
                  <div class="card">
                    <div class="card-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="first_name" class="form-control" disabled="true" placeholder="Enter First Name" value="<?php echo $children_row['first_name'] ?>" >
                              </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="last_name" class="form-control" disabled="true" placeholder="Enter Last Name" value="<?php echo $children_row['last_name'] ?>" >
                              </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-6">
                              <div class="form-group">
                                ...
                                <select name="gender" class="form-control custom-select" disabled="true" >
                                        <option value="" disabled selected><?php echo $children_row['gender'] ?></option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="number" name="contact_num" class="form-control" disabled="true" placeholder="Enter Contact Number" value="<?php echo $children_row['contact_number'] ?>" >
                              </div>
                            </div> 
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="number" name="id_number" class="form-control" disabled="true" placeholder="Enter ID Number" value="<?php echo $children_row['id_number'] ?>" >
                              </div>
                            </div>
                            ...
                            <!-- <div class="col-sm-6 col-md-6">
                              <div class="form-group">
                                ...
                                <select name="relation" class="form-control custom-select" disabled="true" >
                                        <option value="" disabled selected><?php //echo $children_row['relation'] ?></option>
                                </select>
                              </div>
                            </div>  -->   
              ...
              <div class="col-lg-12">
                <div class="card">
                  <a href="./extended_family.php?main_member_id=<?php echo $main_member_id?>" class="btn btn-primary" role="button">Save and continue</a>
                </div>
              </div>
                  ...
                  <form class="card" action="" method="POST">
                    <div class="card-body">
                        ...
                        <!-- <div class="col-sm-6 col-md-6">
                          <div class="form-group">
                            ...
                            <select name="relation" class="form-control custom-select" required="required">
                                    ...
                                    <option value="Great Grand-Mothe">Great Grand-Mother</option>
                            </select>
                          </div>
                        </div>  -->   
                      ...
                      <div class="card-footer text-right">
                        <!-- <button type="submit" name="submit" class="btn btn-primary">Save immediate family and continue</button> -->
                        <button type="submit" name="add" class="btn btn-primary">Add</button>
                        <input type="reset" class="btn btn-primary" value="Reset" />
                        <a href="./extended_family.php?main_member_id=<?php echo $main_member_id?>" class="btn btn-primary" role="button">Skip</a>
                      </div>
