                  ...
                  {?>
                    ...
                    {?>
                      <li class="nav-item dropdown">
                        <a href="./view_report.php" class="nav-link active"><i class="fe fe-file-text"></i> View Reports </a>
                      </li>
                    <?php 
                    }?>
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="page-header">        
              <h1 class="page-title">
                <a href="index.php" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>Home</a> | Reports
              </h1>
            </div>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <small class="text-muted">
                        R<?php echo number_format($total_income,2) ?>  
                      </small>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h4 class="m-0"><a href="view_report_expense.php?date1=<?php $date1 = $_POST['date1']; $date2 = $_POST['date2']; echo $date1 ?> &date2=<?php echo $date2 ?>">
                      <small>Total Expenses</small></a></h4>
