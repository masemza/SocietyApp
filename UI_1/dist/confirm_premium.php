...
if(isset($_POST['edit']))
{
  header('Location: edit_premium.php?main_member_id='.$main_member_id.'&member_payment_id='.$member_payment_id);
}

if(isset($_POST['confirm']))
{
  header('location: premium_successful.php?member_payment_id='.$member_payment_id);

  Print '<script>alert("Premium Successfully Paid");;
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="page-header">
              <h1 class="page-title">
                <a href="./member_statement.php?main_member_id=<?php echo $receipt_row['member_id'] ?>" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>Statement</a> | Confirm Information
              </h1>
            </div>
            ...
            <div class="card">
              ...
              <?php //foreach ($view_statement as $row) { 
                ...
                <div class="row my-6">
                  <div class="col-6">
                      <h3> Member ID: <u><?php echo $receipt_row['member_id']?></u> </h3>
                  </div>
                  <div class="col-6 text-right">
                    <address>
                ...
                <div class="row my-12">
                  <div class="col-12 text-right">
                    <form action="" method="post">
                     <button type="submit" name="edit" class="btn btn-primary">Edit Receipt</button>
