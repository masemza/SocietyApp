...
$view_spouse = $spouse->allSpouseInformation();
                ...
                <form class="input-icon my-3 my-lg-0" action="" method="post" >
                  ...
                  <div class="form-group">
                    <div class="row gutters-xs">
                      <div class="col">
                        <input type="text" name="search" id="myInput" onkeyup="myFunction()" class="form-control" placeholder="Enter Spouse Name" required="required">
                      </div>
                      <span class="col-auto">
                ...
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item">
                      ...
                      <div class="dropdown-menu dropdown-menu-arrow">
                        <a href="./view_all_spouse.php" class="dropdown-item active"><i class="fe fe-users"></i>View Spouse</a>
          ...
          <div class="container">
            <div class="page-header">
              <h1 class="page-title">
                <?php if($type == 'user')
                {?>
                  <a href="./index.php" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>Home</a> | Spouse Details
                <?php
                }
                else if($type == 'admin' || $type == 'manager')
                {?>
                  <a href="./manage_members.php" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>Home</a> | Spouse Details
                <?php
                }?>
              </h1>
            </div>
                  ...
                  <div class="card p-1 align-items-center">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="col-lg order-lg-first">
                        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                          <li class="nav-item">
                            <a href="./view_all_spouse.php?" class="nav-link active"><i class="fe fe-users"></i>View Spouse</a>
                          </li>
                        </ul>
                      </div>
                                    ...
                                    <div class="btn-list text-center" class="input-group button-center">
                                      <div class="btn-list text-center" class="input-group-prepend">
                                        ...
                                        <div class="dropdown-menu">
                                          <a href="./edit_spouse.php?family_id=<?php echo $spouse_row['family_id']?>" class="dropdown-item"><i class="dropdown-icon fe fe-edit"></i> Edit Member </a>
                                          <a href="plan_policy_holder_funeral.php?family_id=<?php echo $spouse_row['family_id'] ?>" class="dropdown-item"><i class="dropdown-icon fe fe-clipboard"></i>Plan a funeral</a>
                                          <a onclick ="return confirm('Are you sure you want to delete <?php echo $spouse_row['first_name'] ?> <?php echo $spouse_row['last_name'] ?>?')" href="./delete_spouse.php?family_id=<?php echo $spouse_row['family_id']?>" class="dropdown-item" class="dropdown-item"><i class="dropdown-icon fe fe-trash-2"></i> Delete Spouse</a>
                                        </div>
                                      </div>
                                    </div>
                                  </td>
