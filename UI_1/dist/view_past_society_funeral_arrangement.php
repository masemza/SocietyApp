...
$view_funeral_arrangement = $funeral->past_society_funeral_arrangement_for_each_society($society_id);
                  ...
                  <div class="card p-1 align-items-center">
                    <div class="d-flex align-items-center">
                      <div class="col-lg order-lg-first">
                        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                          <li class="nav-item">
                            <a href="view_society_funeral_arrangement.php?society_id=<?php echo $society_id ?>" class="nav-link"><i class="fe fe-users"></i>Future Funeral Arrangement</a>
                          </li>
                        </ul>
                      </div>
                    </div>
