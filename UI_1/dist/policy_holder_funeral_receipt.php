        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="page-header">
              <h1 class="page-title">
                  <a href="view_policy_holder_funeral_arrangement.php?main_member_id=<?php echo $row['main_member_id'] ?>"> <i class="fe fe-arrow-left"></i>View Funeral Arrangement</a> | Funeral Arrangement
              </h1>
            </div>
