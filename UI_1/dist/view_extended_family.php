              ...
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow">
                      <a href="./view_extended_family.php?main_member_id=<?php echo $main_member_id ?>" class="dropdown-item active"><i class="fe fe-users"></i>View Extended Family</a>
          ...
          <div class="container">
            <div class="page-header">
              <h1 class="page-title">
                <?php if($type == 'user')
                {?>
                  <a href="./index.php" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>Home</a> | Extended Family Details
                <?php
                }
                else if($type == 'admin' || $type == 'manager')
                {?>
                  <a href="./view_main_member.php?main_member_id=<?php echo $main_member_id ?>" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>Member Details</a> | Extended Family Details
                <?php
                }?>
              </h1>
            </div>
                  ...
                  <div class="card p-1 align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="col-lg order-lg-first">
                          <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                            <li class="nav-item">
                              <a href="./view_children.php?main_member_id=<?php echo $main_member_id ?>" class="nav-link"><i class="fe fe-users"></i>View Children</a>
                            </li>
                          </ul>
                        </div>
                  ...
                  <div class="card p-1 align-items-center">
                    <div class="d-flex">
                          ...
                          <div class="col-lg order-lg-first">
                            <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                              <li class="nav-item">
                                <a href="./view_extended_family.php?main_member_id=<?php echo $main_member_id ?>" class="nav-link active"><i class="fe fe-users"></i> View Extended Family</a>
                              </li>
                            </ul>
                          </div>
                                    ...
                                    <div class="btn-list text-center" class="input-group button-center">
                                      <div class="btn-list text-center" class="input-group-prepend">
                                        ...
                                        <div class="dropdown-menu">
                                          <a href="./edit_extended_family.php?family_id=<?php echo $extended_family_row['family_id']?>" class="dropdown-item"><i class="dropdown-icon fe fe-edit"></i> Edit Member </a>
                                          <a href="plan_policy_holder_funeral.php?family_id=<?php echo $extended_family_row['family_id'] ?>" class="dropdown-item"><i class="dropdown-icon fe fe-clipboard"></i>Plan a funeral</a>
                                          <a onclick ="return confirm('Are you sure you want to delete <?php echo $extended_family_row['first_name'] ?> <?php echo $extended_family_row['last_name'] ?>?')" href="./delete_extended_family.php?family_id=<?php echo $extended_family_row['family_id']?>" class="dropdown-item" class="dropdown-item"><i class="dropdown-icon fe fe-trash-2"></i> Delete Member</a>
                                        </div>
                                      </div>
                                    </div>
                                  </td>
