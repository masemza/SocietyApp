...
$view_funeral_arrangement = $funeral->policy_holder_funeral_arrangement_for_each_society($main_member_id);
                  ...
                  <div class="card p-1 align-items-center">
                    <div class="d-flex align-items-center">
                        <div class="col-lg order-lg-first">
                          <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                            <li class="nav-item">
                              <a href="./view_past_policy_holder_funeral_arrangement.php?main_member_id=<?php echo $main_member_id ?>" class="nav-link"><i class="fe fe-users"></i>Past Funeral Arrangement</a>
                            </li>
                          </ul>
                        </div>
                    </div>
                    ...
                    <form action="" method="post" class="text-center">
                      ...
                      <div class="table-responsive push">
                        ...
                        {?>
                            ...
                            {?>
                              <h1 class="page-title">
                                There is no funeral arrangement happening soon for this Policy Holder
                              </h1>
                            <?php
                            }?>
