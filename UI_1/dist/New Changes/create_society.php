            ...
            <div class="col-lg-12">
              <form class="card" action="" method="post">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="society_name" class="form-control" placeholder="Society Name" required="required" >
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    <label class="form-label">Location </label>
                      <input type="text" name="addr1" class="form-control" placeholder="Street" />
                      </div>

                      <div class="form-group">
                      <input type="text" name="addr2" class="form-control" placeholder="Suburb" />
                      </div>

                      <div class="form-group">
                      <input type="text" name="addr3" class="form-control" placeholder="City" required="required" />
                      </div>

                      <div class="form-group">
                      <input type="text" name="addr4" class="form-control" placeholder="Province" required="required" />
                      </div>
                  </div>
                    ...
                    <div class="col-sm-6 col-md-6">
                      <div class="form-group">
                        ...
                        <input type="number" name="init_capital" class="form-control" placeholder="Initial Capital" required="required" >
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="date" name="date_inception" class="form-control" required="required" >
                      </div>
                    </div>
