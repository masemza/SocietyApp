...
if(isset($_POST['submit']))
{
    ...
    {
        $expense = $expense->daily_expense();
       // $expense_total = $expense->sum_of_daily_expense();
    }
    else if ($choice_selected == "Weekly")
    {
        $expense = $expense->weekly_expense();
        //$expense_total = $expense->sum_of_weekly_expense();
    }
    else if ($choice_selected == "Monthly")
    {
        $expense = $expense->monthly_deposits();
       // $expense_total = $expense->sum_of_monthly_expense();
    }
                  ...
                  <div class="page-header">
                      <h1 class="page-title">
                          <a href="index.php" style="text-decoration: none;"> <i class="fe fe-arrow-left"></i>Home</a> | 
                                <?php if(isset($_POST['submit'])) { echo $choice_selected ?> Transactions <?php } 
                                else echo "Daily Transactions" ?>
                        </h1>
                  </div>
...
<input type="submit" name="submit" value="Click here to view selected transactions" />
</form>
                                    ...
                                    <form action="" method="post" class="text-center">
                                        ...
                                        {?> 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <p class="font-w600 mb-1 text-center"><?php echo $view_expense['date_transaction']; ?></p>
                                                </td>
                                                <td class="text-center">
                                                Society name: <?php echo $view_expense['society_name']; ?>
                                                </td>
                                                <td class="text-center"><?php echo $view_expense['name']; ?></td>
                                                <td class="text-center">Deposit</td>
                                                <td class="text-center"><?php echo $view_expense['credit']; ?></td>
                                            </tr>
                                            <?php } ?>
            ...
            if (shouldSwitch) 
            {
                ...
                switching = true;
                                        ...
                                        <tr>
                                            ...
                                            if(isset($_POST['submit'])) 
                                            { 
                                                echo $choice_selected ?> Expense Total <?php
                                            } 
                                            else echo "Daily Total" ?>: R<?php echo number_format($deposits_total,2); ?>

                                        </tr>
                                        <?php } ?> Select a transaction <?php  ?>
                                        </div>                                            
                                    </form>
